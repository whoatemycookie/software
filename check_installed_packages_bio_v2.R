...
bioconductor_packages = c("BiocManager","rhdf5","Biobase","DESeq2","edgeR","clusterProfiler","pathview","enrichplot","karyoploteR","diffloop","regioneR","TxDb.Hsapiens.UCSC.hg19.knownGene","ComplexHeatmap","esATAC","phyloseq","tximport","biomaRt","WGCNA","limma","AnnotationHub","RDAVIDWebService","org.Hs.eg.db","TxDb.Hsapiens.UCSC.hg19.knownGene","rtracklayer","TCGAbiolinks","SummarizedExperiment")
